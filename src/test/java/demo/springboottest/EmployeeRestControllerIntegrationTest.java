...
public class EmployeeRestControllerIntegrationTest {
	    ...
	    public void whenValidInput_thenCreateEmployee() throws Exception {
	        ...
	        mvc.perform(post("/rmtest/employees").contentType(MediaType.APPLICATION_JSON).content(JsonUtil.toJson(employee1)));
	    ...
	    public void givenEmployees_whenGetEmployees_thenStatus200() throws Exception {
	        ...
	        mvc.perform(get("/rmtest/employees").contentType(MediaType.APPLICATION_JSON))
	          ...
	          .andExpect(jsonPath("$[0].name", is("Employee 3")))
	          .andExpect(jsonPath("$[1].name", is("Employee 4")));
	    }
